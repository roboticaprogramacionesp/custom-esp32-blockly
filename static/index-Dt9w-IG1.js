...
let r = class extends n {
          ...
          (null ===
            (t =
              null === (e = window.navigator) || void 0 === e
                ? void 0
                : e.userAgentData) || void 0 === t
            ? void 0
            : t.platform) || window.navigator.platform;
      return -1 !==
        ["macOS", "Macintosh", "MacIntel", "MacPPC", "Mac68K"].indexOf(i)
        ? "Mac OS"
        : -1 !== ["iPhone", "iPad", "iPod"].indexOf(i)
          ? "iOS"
          : -1 !== ["Win32", "Win64", "Windows", "WinCE"].indexOf(i)
            ? "Windows"
            : /Android/.test(o)
              ? "Android"
              : /Linux/.test(i)
  ...
  tryAgain() {
    var e;
    (this.close(),
      null === (e = this.doTryAgain) || void 0 === e || e.call(this));
  }
  close() {
