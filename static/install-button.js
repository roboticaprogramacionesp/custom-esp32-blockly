const e = async (t) => {
  let o;
  import("./install-dialog-C5LjR_e6.js");
  try {
    o = await navigator.serial.requestPort();
  } catch (o) {
    return "NotFoundError" === o.name
      ? void import("./index-Dt9w-IG1.js").then((o) =>
          o.openNoPortPickedDialog(() => e(t)),
        )
      : void alert(`Error: ${o.message}`);
  }
  if (!o) return;
  try {
